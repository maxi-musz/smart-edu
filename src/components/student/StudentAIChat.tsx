            ...
            <div className="flex-grow overflow-y-auto space-y-4 p-2">
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="flex-grow">
                  <div className="bg-muted p-3 rounded-lg inline-block">
                    <p className="text-sm">
                      Of course! A derivative measures the rate of change of a function
                      at a particular point. Think of it as the slope of the tangent
                      line at that point. Would you like me to explain this further
                      with some examples?
                    </p>
                  </div>
                </div>
