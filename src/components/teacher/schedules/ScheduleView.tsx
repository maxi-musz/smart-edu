...
const ScheduleView = () => {
  ...
  return (
    <div className="content-area">
      ...
      {viewMode === 'week' ? (
        /* Week View */
        <Tabs defaultValue={selectedDay} onValueChange={(value) => setSelectedDay(value)}>
              ...
              <Card>
                ...
                <CardContent>
                  {mockSchedule.filter(item => item.day === day).length > 0 ? (
                    ...
                    <p className="text-center py-8 text-gray-500">No classes scheduled for {day}</p>
                  )}
                </CardContent>
              </Card>
            </TabsContent>
                ...
                {daySchedule.map(item => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-700">{item.startTime} - {item.endTime}</p>
