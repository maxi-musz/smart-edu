...
const AdminScheduleView = () => {
  ...
  const handleAddSchedule = () => {
    if (!newSchedule.courseName || !newSchedule.courseCode || !newSchedule.day || !newSchedule.startTime || !newSchedule.endTime) {
                ...
                <TableRow key={schedule.id}>
                  ...
                  <TableCell>
                    <div>
                      ...
                      <div className="text-sm mt-1">{schedule.startTime} - {schedule.endTime}</div>
                    </div>
                  </TableCell>
                  <TableCell>{schedule.room}</TableCell>
                  <TableCell>
                    <div className="space-y-1">
                      <div className="text-sm">{schedule.enrolled} / {schedule.capacity}</div>
