  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      content: 'Please find attached the examination schedule for the upcoming end of term assessments.',
      sender: 'Admin',
    ...
    },
    {
      ...
      content: 'Reminder about the upcoming parent-teacher meeting scheduled for next week.',
      sender: 'Admin',
      recipient: 'Class 10A',
      recipientType: 'class',
      status: 'sent',
    ...
    },
    {
      ...
      content: 'New library access protocols will be implemented starting next month.',
      sender: 'Admin',
