...
import { Search, Plus, Pencil, Trash2, BookOpen, GraduationCap, Clock, Users } from 'lucide-react';
          ...
          <CardContent className="pt-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <h3 className="text-2xl font-bold text-green-600">{activeCourses}</h3>
              </div>
          ...
          <CardContent className="pt-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <h3 className="text-2xl font-bold text-blue-600">{totalEnrollments}</h3>
              </div>
          ...
          <CardContent className="pt-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <h3 className="text-2xl font-bold text-yellow-600">{archivedCourses}</h3>
              </div>
                ...
                <TableRow key={course.id}>
                  ...
                  <TableCell>
                    <div className="space-y-1">
                      <div className="text-sm">{course.enrolled} / {course.capacity}</div>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        ...
                        course.status === 'inactive' ? 'destructive' :
                        'destructive'
                      }
                    >
                      {course.status}
