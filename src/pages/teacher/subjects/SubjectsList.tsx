          ...
          <Card key={subject.id} className="overflow-hidden card-hover">
            ...
            <CardHeader className="pb-2">
              <CardTitle className="flex justify-between items-start">
                <div>
                  <h3>{subject.name}</h3>
                  <p className="text-sm font-normal text-gray-500">{subject.code}</p>
                </div>
                <Button 
                  variant="ghost" 
                  size="icon" 
              ...
              <Tabs defaultValue="overview">
                ...
                <TabsContent value="overview" className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-600">{subject.nextClass}</span>
                  </div>
                </TabsContent>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-sm font-medium">{subject.averageGrade}%</span>
                      </div>
                      <Progress 
                        value={subject.averageGrade} 
                        className="h-2"
                        indicatorClassName={
                          subject.averageGrade >= 80 ? 'bg-edu-success' : 
                          subject.averageGrade >= 70 ? 'bg-edu-accent' : 'bg-edu-danger'
                        }
                      />
                    </div>
                            ...
                            <div className="h-16 bg-gray-100 rounded-t-sm relative">
                              <div 
                                ...
                                style={{ 
                                  ...
                                  opacity: grade === 'A' ? 1 : grade === 'B' ? 0.8 : grade === 'C' ? 0.6 : 0.4
                                }}
                              />
                            </div>
